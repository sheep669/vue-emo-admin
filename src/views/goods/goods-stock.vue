        ...
        >
            <el-form>
                ...
                <el-form-item label="商品分类 :" :label-width="formLabelWidth">
                    <el-input
                        clearable
                        v-model="dialogConfig.goodsCategory"
                        placeholder="请输入商品分类"
                    ></el-input>
                </el-form-item>
                ...
                <el-form-item label="显示销量 :" :label-width="formLabelWidth">
                    <el-input
                        clearable
                ...
                <el-form-item label="真实销量 :" :label-width="formLabelWidth">
                    <el-input
                        clearable
...
export default {
    ...
    methods: {
        ...
        doAddOrEdit() {
            //编辑模式
            if (this.eidtModel) {
                let url_param = constant.goods.updateUrl;
                ...
                //添加模式
                let url_param = constant.goods.addUrl;
                let data_param = this.dialogConfig;
