                        ...
                        <el-form label-width="100px" class="emo-form-inline">
                            <el-form-item label="分类名称">
                                <el-input
                                    style="width: 520px"
                                    clearable
                                    v-model="request_config.form.categoryName"
                                    placeholder="请输入分类名称"
                                ></el-input>
                            </el-form-item>
                        </el-form>
        ...
        >
            <el-form>
                ...
                <el-form-item label="分类名称 :" :label-width="formLabelWidth">
                    <el-input
                        clearable
                        v-model="dialogConfig.categoryName"
                        placeholder="请输入分类名称"
                    ></el-input>
                </el-form-item>
                <el-form-item label="商品数量 :" :label-width="formLabelWidth">
                    <el-input
                        clearable
                        v-model="dialogConfig.goodsNumber"
                        placeholder="请输入商品数量"
                    ></el-input>
                </el-form-item>
                <el-form-item label="排序 :" :label-width="formLabelWidth">
                    <el-input
                        clearable
                        v-model="dialogConfig.sort"
                        placeholder="请输入排序(必须为数字)"
                    ></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        doAddOrEdit() {
            //编辑模式
            if (this.eidtModel) {
                let url_param = constant.gca.updateUrl;
                let data_param = this.dialogConfig;
                console.log(data_param);
                data_param.goodsStatus = this.value;
                ...
                //添加模式
                let url_param = constant.gca.addUrl;
                let data_param = this.dialogConfig;
        ...
        handleAdd() {
            ...
            this.dialogTitle = "添加产品分类信息";
        },
        handleEdit(id, data) {
            console.log(id, data);
            this.eidtModel = true;
            this.dialogConfig = data;
            this.value = parseInt(data.goodsStatus);
            this.dialogFormVisible = true;
            this.dialogTitle = "编辑产品分类信息";
        },
        handleDelete(id) {
            console.log(id);
            doDeleteRequest(constant.gca.deleteUrl, id).then((res) => {
                console.log(res);
                if (res.data.code === 200) {
                    this.$message({
                        message: "删除成功",
        ...
        delBatch() {
            if (this.delIds.length == 0) {
                ...
                doPostRequest(constant.gca.deleteBatchUrl, this.delIds).then(
                    (res) => {
                        console.log(res);
                        if (res.data.code === 200) {
                            this.$message({
