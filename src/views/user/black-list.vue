        ...
        <el-card shadow="always" body-style="0px" style="margin: 8px">
            ...
            >
                ...
                <template v-slot:operation="slotData">
                    <el-button
                        size="mini"
                        @click="removeBlacklist(slotData.data.id)"
                        >移出黑名单</el-button
                    >
                    <el-popconfirm
...
export default {
    ...
    methods: {
        ...
        removeBlacklist(id) {
            console.log("id", id);
            doAuditRequest(constant.member.removeBlacklistUrl, id).then(
                (res) => {
        ...
        serachData() {
            ...
            if (isInput) {
                let data = {
                    memberStatus: "0",
                    username: this.request_config.form.username,
                };
                searchOrGetRequest(
