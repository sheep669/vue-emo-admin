                    ...
                    <el-col :span="13">
                        <el-form label-width="100px" class="emo-form-inline">
                            <el-form-item label="配送员">
                                <el-input
                                    clearable
                                    v-model="request_config.form.deliveryMan"
        ...
        >
            <el-form>
                ...
                <el-form-item label="路线名称 :" :label-width="formLabelWidth">
                    <el-input
                        clearable
                        v-model="dialogConfig.deliveryRoute"
                        placeholder="请输入路线名称"
                    ></el-input>
                </el-form-item>
                <el-form-item label="配送员 :" :label-width="formLabelWidth">
                    <el-input
                        clearable
                        v-model="dialogConfig.deliveryMan"
                        placeholder="请输入配送员"
                    ></el-input>
                </el-form-item>
...
export default {
        ...
        return {
            ...
            table_config: {
                thead: [
                    ...
                    { label: "配送员", prop: "deliveryMan", width: 200 },
                    {
                        label: "联系电话",
                        prop: "phoneNumber",
                        width: 200,
    ...
    methods: {
        ...
        doAddOrEdit() {
            //编辑模式
            if (this.eidtModel) {
                let url_param = constant.dr.updateUrl;
                ...
                //添加模式
                let url_param = constant.dr.addUrl;
                let data_param = this.dialogConfig;
        ...
        handleEdit(id, data) {
            ...
            this.dialogFormVisible = true;
            this.dialogTitle = "编辑配送路线";
        },
        handleDelete(id) {
            console.log(id);
            doDeleteRequest(constant.dr.deleteUrl, id).then((res) => {
                console.log(res);
                if (res.data.code === 200) {
                    this.$message({
                        message: "删除成功",
        ...
        delBatch() {
            if (this.delIds.length == 0) {
                ...
                doPostRequest(constant.dr.deleteBatchUrl, this.delIds).then(
                    (res) => {
                        console.log(res);
                        if (res.data.code === 200) {
                            this.$message({
        ...
        serachData() {
            ...
            if (isInput) {
                searchOrGetRequest(
                    constant.dr.searchOrGetPageList,
                    page_parm,
                    data_param
                ).then((res) => {
                    if (res.data.code == 200) {
